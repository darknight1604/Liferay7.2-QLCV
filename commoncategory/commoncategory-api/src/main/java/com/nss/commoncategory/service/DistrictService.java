...
public interface DistrictService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DistrictServiceUtil} to access the district remote service. Add custom service methods to <code>com.nss.commoncategory.service.impl.DistrictServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public District updateDistrict(
			...
			boolean active, ServiceContext serContext)
		throws PortalException;
