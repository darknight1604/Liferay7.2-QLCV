 ...
 * <code>com.nss.commoncategory.service.impl.ContinentServiceImpl</code> and is an
...
public class ContinentServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nss.commoncategory.service.impl.ContinentServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static
		...
		return getService().getMyPermissionChecker();
	}
	...
	private static ServiceTracker<ContinentService, ContinentService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ContinentService.class);

		ServiceTracker<ContinentService, ContinentService> serviceTracker =
			new ServiceTracker<ContinentService, ContinentService>(
				bundle.getBundleContext(), ContinentService.class, null);
