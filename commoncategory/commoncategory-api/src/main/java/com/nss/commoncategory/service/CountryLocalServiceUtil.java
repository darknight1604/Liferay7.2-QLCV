 ...
 * <code>com.nss.commoncategory.service.impl.CountryLocalServiceImpl</code> and
...
public class CountryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nss.commoncategory.service.impl.CountryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.nss.commoncategory.model.Country createCountry(
		long countryId) {
	 ...
	 */
	public static com.nss.commoncategory.model.Country deleteCountry(
		com.nss.commoncategory.model.Country country) {
	...
	public static com.nss.commoncategory.model.Country fetchByCode(
		String code) {

		return getService().fetchByCode(code);
	}

	public static com.nss.commoncategory.model.Country fetchCountry(
		long countryId) {

		return getService().fetchCountry(countryId);
	}

	public static java.util.List<com.nss.commoncategory.model.Country>
	 ...
	 * @throws PortalException if a country with the primary key could not be found
	 */
	public static com.nss.commoncategory.model.Country getCountry(
			long countryId)
		throws com.liferay.portal.kernel.exception.PortalException {
