...
/**
 * Provides the remote service utility for Ward. This utility wraps
 * <code>com.nss.commoncategory.service.impl.WardServiceImpl</code> and is an
 ...
 */
@ProviderType
public class WardServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nss.commoncategory.service.impl.WardServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	private static ServiceTracker<WardService, WardService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WardService.class);

		ServiceTracker<WardService, WardService> serviceTracker =
			new ServiceTracker<WardService, WardService>(
				bundle.getBundleContext(), WardService.class, null);
