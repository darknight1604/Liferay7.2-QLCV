...
/**
 * Provides the remote service interface for Street. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see StreetServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface StreetService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StreetServiceUtil} to access the street remote service. Add custom service methods to <code>com.nss.commoncategory.service.impl.StreetServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
