...
/**
 * Provides the local service interface for Street. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StreetLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface StreetLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StreetLocalServiceUtil} to access the street local service. Add custom service methods to <code>com.nss.commoncategory.service.impl.StreetLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public List<Street> findByBaseSearch(
			long companyId, long groupId, long countryId, long cityId,
			long districtId, long wardId, int active, String name, String code,
