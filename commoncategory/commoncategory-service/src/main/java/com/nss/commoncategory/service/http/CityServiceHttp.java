...
public class CityServiceHttp {
	...
	public static boolean hasAddPermission(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CityServiceUtil.class, "hasAddPermission",
	...
	public static boolean hasUpdatePermission(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CityServiceUtil.class, "hasUpdatePermission",
	...
	public static boolean hasViewPermission(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CityServiceUtil.class, "hasViewPermission",
	...
	public static com.nss.commoncategory.model.City addCity(
			...
			String name, String code, String description, int priority,
			int countCode, boolean active,
			com.liferay.portal.kernel.service.ServiceContext serContext)
		throws com.liferay.portal.kernel.exception.PortalException {

		try {
			MethodKey methodKey = new MethodKey(
				CityServiceUtil.class, "addCity", _addCityParameterTypes3);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, userId, countryId, name, code, description, priority,
			...
			return (com.nss.commoncategory.model.City)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	public static com.nss.commoncategory.model.City updateCity(
			HttpPrincipal httpPrincipal, long cityId, long countryId,
			String name, String code, String description, int priority,
			int countCode, boolean active,
			com.liferay.portal.kernel.service.ServiceContext serContext)
		throws com.liferay.portal.kernel.exception.PortalException {
		...
		try {
			MethodKey methodKey = new MethodKey(
				CityServiceUtil.class, "updateCity",
				_updateCityParameterTypes4);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, cityId, countryId, name, code, description, priority,
				countCode, active, serContext);
	...
	private static Log _log = LogFactoryUtil.getLog(CityServiceHttp.class);
	...
	private static final Class<?>[] _hasViewPermissionParameterTypes2 =
		new Class[] {long.class};
	private static final Class<?>[] _addCityParameterTypes3 = new Class[] {
		long.class, long.class, String.class, String.class, String.class,
		int.class, int.class, boolean.class,
		com.liferay.portal.kernel.service.ServiceContext.class
	};
	private static final Class<?>[] _updateCityParameterTypes4 = new Class[] {
		long.class, long.class, String.class, String.class, String.class,
		int.class, int.class, boolean.class,
		com.liferay.portal.kernel.service.ServiceContext.class
	};
