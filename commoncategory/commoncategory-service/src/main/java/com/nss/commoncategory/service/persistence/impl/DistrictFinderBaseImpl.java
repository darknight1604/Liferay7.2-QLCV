 ...
 * @generated
 */
public abstract class DistrictFinderBaseImpl
	extends BasePersistenceImpl<District> {

	public DistrictFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return districtPersistence.getBadColumnNames();
	}
