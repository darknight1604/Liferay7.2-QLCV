 ...
 * @generated
 */
public abstract class ContinentFinderBaseImpl
	extends BasePersistenceImpl<Continent> {

	public ContinentFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return continentPersistence.getBadColumnNames();
	}
