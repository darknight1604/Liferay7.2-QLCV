 ...
 * @generated
 */
public abstract class CityFinderBaseImpl extends BasePersistenceImpl<City> {

	public CityFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return cityPersistence.getBadColumnNames();
	}
