...
/**
 * The extended model implementation for the Ward service. Represents a row in the &quot;nss_platform_ward&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * Helper methods and all application logic should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.nss.commoncategory.model.Ward</code> interface.
 * </p>
 *
 * @author Brian Wing Shun Chan
 */
@ProviderType
public class WardImpl extends WardBaseImpl {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. All methods that expect a ward model instance should use the {@link com.nss.commoncategory.model.Ward} interface instead.
	 */
	private City city;
