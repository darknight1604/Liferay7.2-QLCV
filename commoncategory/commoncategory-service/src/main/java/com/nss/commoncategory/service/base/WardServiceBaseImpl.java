...
/**
 * Provides the base implementation for the ward remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nss.commoncategory.service.impl.WardServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nss.commoncategory.service.impl.WardServiceImpl
 * @generated
 */
public abstract class WardServiceBaseImpl
	extends BaseServiceImpl
	implements WardService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WardService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nss.commoncategory.service.WardServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WardService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		wardService = (WardService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WardService.class.getName();
	}
	...
	@Reference
	protected com.nss.commoncategory.service.WardLocalService wardLocalService;
