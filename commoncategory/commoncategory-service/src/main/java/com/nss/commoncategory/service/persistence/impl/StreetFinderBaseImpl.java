 ...
 * @generated
 */
public abstract class StreetFinderBaseImpl extends BasePersistenceImpl<Street> {

	public StreetFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return streetPersistence.getBadColumnNames();
	}
