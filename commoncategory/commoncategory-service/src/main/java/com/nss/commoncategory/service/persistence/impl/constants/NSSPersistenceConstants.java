...
package com.nss.commoncategory.service.persistence.impl.constants;
 ...
 * @generated
 */
public class NSSPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME =
		"com.nss.commoncategory.service";

	public static final String ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER =
		"(origin.bundle.symbolic.name=" + BUNDLE_SYMBOLIC_NAME + ")";

	static {
		Bundle bundle = FrameworkUtil.getBundle(NSSPersistenceConstants.class);
