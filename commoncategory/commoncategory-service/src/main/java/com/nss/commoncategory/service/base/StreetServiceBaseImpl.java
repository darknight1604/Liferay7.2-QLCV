...
/**
 * Provides the base implementation for the street remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nss.commoncategory.service.impl.StreetServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nss.commoncategory.service.impl.StreetServiceImpl
 * @generated
 */
public abstract class StreetServiceBaseImpl
	extends BaseServiceImpl
	implements StreetService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StreetService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nss.commoncategory.service.StreetServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StreetService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		streetService = (StreetService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return StreetService.class.getName();
	}
	...
	@Reference
	protected com.nss.commoncategory.service.StreetLocalService
		streetLocalService;
