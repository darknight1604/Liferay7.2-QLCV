...
import com.nss.commoncategory.service.base.CityServiceBaseImpl;

import org.osgi.service.component.annotations.Component;

/**
 * The implementation of the city remote service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.nss.commoncategory.service.CityService</code> interface.
 *
 * <p>
...
public class CityServiceImpl extends CityServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use <code>com.nss.commoncategory.service.CityServiceUtil</code> to access the city remote service.
	 */
	private static volatile PortletResourcePermission _portletResourcePermission = PortletResourcePermissionFactory.getInstance(CityServiceImpl.class, "_portletResourcePermission", ResourceConstants.RESOURCE_NAME);
	
	public boolean hasAddPermission(long groupId) throws PrincipalException {
		return _portletResourcePermission.contains(getPermissionChecker(), groupId, MyActionKeys.ADD_CITY);
	}
	...
	public City addCity(long userId, long countryId, String name, 
		...
		_portletResourcePermission.check(getPermissionChecker(), serContext.getScopeGroupId(),
		        MyActionKeys.ADD_CITY);
		return cityLocalService.addCity(userId, countryId, name, 
	...
	public City updateCity(long cityId, long countryId, String name, 
		...
		_portletResourcePermission.check(getPermissionChecker(), city.getGroupId(),
		        MyActionKeys.UPDATE);
		return cityLocalService.updateCity(cityId, countryId, name, 
				code, description, priority, countCode, active, serContext);
	}
}