 ...
 * @see TaskTypeServiceSoap
 * @generated
 */
@ProviderType
public class TaskTypeServiceHttp {
	...
	public static com.nss.taskcategory.model.TaskType addTaskType(
		...
		try {
			MethodKey methodKey = new MethodKey(
				TaskTypeServiceUtil.class, "addTaskType",
				_addTaskTypeParameterTypes0);
			...
			return (com.nss.taskcategory.model.TaskType)returnObj;
		}
	...
	public static com.nss.taskcategory.model.TaskType updateTaskType(
		...
		try {
			MethodKey methodKey = new MethodKey(
				TaskTypeServiceUtil.class, "updateTaskType",
				_updateTaskTypeParameterTypes1);
	...
	public static boolean hasAddPermission(
		...
		try {
			MethodKey methodKey = new MethodKey(
				TaskTypeServiceUtil.class, "hasAddPermission",
	...
	public static boolean hasUpdatePermission(
		...
		try {
			MethodKey methodKey = new MethodKey(
				TaskTypeServiceUtil.class, "hasUpdatePermission",
	...
	public static boolean hasViewPermission(
		...
		try {
			MethodKey methodKey = new MethodKey(
				TaskTypeServiceUtil.class, "hasViewPermission",
	...
	private static Log _log = LogFactoryUtil.getLog(TaskTypeServiceHttp.class);

	private static final Class<?>[] _addTaskTypeParameterTypes0 = new Class[] {
		long.class, String.class, String.class, int.class, boolean.class,
		String.class, com.liferay.portal.kernel.service.ServiceContext.class
	};
	private static final Class<?>[] _updateTaskTypeParameterTypes1 =
		new Class[] {
			long.class, String.class, String.class, int.class, boolean.class,
			String.class, com.liferay.portal.kernel.service.ServiceContext.class
		};
