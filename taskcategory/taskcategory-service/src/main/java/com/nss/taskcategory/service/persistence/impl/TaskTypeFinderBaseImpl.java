 ...
 * @generated
 */
public abstract class TaskTypeFinderBaseImpl
	extends BasePersistenceImpl<TaskType> {

	public TaskTypeFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return taskTypePersistence.getBadColumnNames();
	}
