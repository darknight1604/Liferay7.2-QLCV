...
/**
 * The persistence implementation for the task group service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = TaskGroupPersistence.class)
@ProviderType
public class TaskGroupPersistenceImpl
	extends BasePersistenceImpl<TaskGroup> implements TaskGroupPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>TaskGroupUtil</code> to access the task group persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		TaskGroupImpl.class.getName();
	 ...
	 */
	@Override
	public List<TaskGroup> findByCompanyId(long companyId, int start, int end) {
	...
	@Deprecated
	@Override
	public List<TaskGroup> findByCompanyId(
	...
	public List<TaskGroup> findByCompanyId(
		...
		List<TaskGroup> list = (List<TaskGroup>)finderCache.getResult(
			finderPath, finderArgs, this);

		if ((list != null) && !list.isEmpty()) {
			for (TaskGroup taskGroup : list) {
				if ((companyId != taskGroup.getCompanyId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_TASKGROUP_WHERE);
			...
			if (orderByComparator != null) {
				...
				query.append(TaskGroupModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				if (!pagination) {
					list = (List<TaskGroup>)QueryUtil.list(
	...
	public TaskGroup findByCompanyId_First(
		...
		TaskGroup taskGroup = fetchByCompanyId_First(
		...
		throw new NoSuchTaskGroupException(msg.toString());
	}
	...
	public TaskGroup fetchByCompanyId_First(
		...
		List<TaskGroup> list = findByCompanyId(
	...
	public TaskGroup findByCompanyId_Last(
		...
		TaskGroup taskGroup = fetchByCompanyId_Last(
			companyId, orderByComparator);
	...
	public TaskGroup[] findByCompanyId_PrevAndNext(
		...
		TaskGroup taskGroup = findByPrimaryKey(taskGroupId);
		...
		try {
			...
			TaskGroup[] array = new TaskGroupImpl[3];

			array[0] = getByCompanyId_PrevAndNext(
				session, taskGroup, companyId, orderByComparator, true);

			array[1] = taskGroup;

			array[2] = getByCompanyId_PrevAndNext(
				session, taskGroup, companyId, orderByComparator, false);
	...
	protected TaskGroup getByCompanyId_PrevAndNext(
		Session session, TaskGroup taskGroup, long companyId,
		OrderByComparator<TaskGroup> orderByComparator, boolean previous) {
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(taskGroup)) {

				qPos.add(orderByConditionValue);
			}
		}

		List<TaskGroup> list = q.list();
	...
	public int countByCompanyId(long companyId) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_TASKGROUP_WHERE);
	...
	public TaskGroup findByCompanyId_Active_First(
		...
		TaskGroup taskGroup = fetchByCompanyId_Active_First(
	...
	public TaskGroup fetchByCompanyId_Active_First(
		...
		List<TaskGroup> list = findByCompanyId_Active(
	...
	public TaskGroup findByCompanyId_Active_Last(
		...
		TaskGroup taskGroup = fetchByCompanyId_Active_Last(
			companyId, active, orderByComparator);
	...
	public TaskGroup[] findByCompanyId_Active_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompanyId_Active_PrevAndNext(
				session, taskGroup, companyId, active, orderByComparator, true);

			array[1] = taskGroup;

			array[2] = getByCompanyId_Active_PrevAndNext(
				session, taskGroup, companyId, active, orderByComparator,
				false);
	...
	protected TaskGroup getByCompanyId_Active_PrevAndNext(
		Session session, TaskGroup taskGroup, long companyId, boolean active,
		OrderByComparator<TaskGroup> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<TaskGroup> findByActive(boolean active, int start, int end) {
	...
	@Deprecated
	@Override
	public List<TaskGroup> findByActive(
	...
	public TaskGroup findByActive_First(
		...
		TaskGroup taskGroup = fetchByActive_First(active, orderByComparator);
	...
	public TaskGroup fetchByActive_First(
		...
		List<TaskGroup> list = findByActive(active, 0, 1, orderByComparator);
	...
	public TaskGroup findByActive_Last(
		...
		TaskGroup taskGroup = fetchByActive_Last(active, orderByComparator);
	...
	public TaskGroup fetchByActive_Last(
		...
		List<TaskGroup> list = findByActive(
	...
	public TaskGroup[] findByActive_PrevAndNext(
		...
		try {
			...
			array[0] = getByActive_PrevAndNext(
				session, taskGroup, active, orderByComparator, true);

			array[1] = taskGroup;

			array[2] = getByActive_PrevAndNext(
				session, taskGroup, active, orderByComparator, false);
	...
	protected TaskGroup getByActive_PrevAndNext(
		Session session, TaskGroup taskGroup, boolean active,
		OrderByComparator<TaskGroup> orderByComparator, boolean previous) {
	...
	public TaskGroup fetchByCode(String code) {
		...
		if (result instanceof TaskGroup) {
			TaskGroup taskGroup = (TaskGroup)result;

			if (!Objects.equals(code, taskGroup.getCode())) {
				result = null;
			}
		}
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"TaskGroupPersistenceImpl.fetchByCode(String, boolean) with parameters (" +
									StringUtil.merge(finderArgs) +
										") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}

					TaskGroup taskGroup = list.get(0);

					result = taskGroup;

					cacheResult(taskGroup);
				}
			}
			catch (Exception e) {
	...
	public TaskGroup removeByCode(String code) throws NoSuchTaskGroupException {
		TaskGroup taskGroup = findByCode(code);

		return remove(taskGroup);
	}
	...
	private static final String _FINDER_COLUMN_CODE_CODE_3 =
		"(taskGroup.code IS NULL OR taskGroup.code = '')";

	public TaskGroupPersistenceImpl() {
		setModelClass(TaskGroup.class);

		setModelImplClass(TaskGroupImpl.class);
	...
	public void cacheResult(TaskGroup taskGroup) {
		entityCache.putResult(
			entityCacheEnabled, TaskGroupImpl.class, taskGroup.getPrimaryKey(),
			taskGroup);

		finderCache.putResult(
			_finderPathFetchByCode, new Object[] {taskGroup.getCode()},
			taskGroup);

		taskGroup.resetOriginalValues();
	}
	 ...
	 */
	@Override
	public void cacheResult(List<TaskGroup> taskGroups) {
		for (TaskGroup taskGroup : taskGroups) {
			if (entityCache.getResult(
					entityCacheEnabled, TaskGroupImpl.class,
					taskGroup.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all task groups.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(TaskGroupImpl.class);
	...
	/**
	 * Clears the cache for the task group.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(TaskGroup taskGroup) {
		...
		clearUniqueFindersCache((TaskGroupModelImpl)taskGroup, true);
	}

	@Override
	public void clearCache(List<TaskGroup> taskGroups) {
		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITH_PAGINATION);
		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
	...
	protected void cacheUniqueFindersCache(
		TaskGroupModelImpl taskGroupModelImpl) {

		Object[] args = new Object[] {taskGroupModelImpl.getCode()};

		finderCache.putResult(
			_finderPathCountByCode, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByCode, args, taskGroupModelImpl, false);
	}

	protected void clearUniqueFindersCache(
		TaskGroupModelImpl taskGroupModelImpl, boolean clearCurrent) {
		...
		if ((taskGroupModelImpl.getColumnBitmask() &
			 _finderPathFetchByCode.getColumnBitmask()) != 0) {

			Object[] args = new Object[] {taskGroupModelImpl.getOriginalCode()};
	...
	public TaskGroup create(long taskGroupId) {
		TaskGroup taskGroup = new TaskGroupImpl();

		taskGroup.setNew(true);
		taskGroup.setPrimaryKey(taskGroupId);

		taskGroup.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public TaskGroup remove(long taskGroupId) throws NoSuchTaskGroupException {
		return remove((Serializable)taskGroupId);
	}

	/**
	 * Removes the task group with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the task group
	 * @return the task group that was removed
	 * @throws NoSuchTaskGroupException if a task group with the primary key could not be found
	 */
	@Override
	public TaskGroup remove(Serializable primaryKey)
		throws NoSuchTaskGroupException {
		...
		try {
			...
			TaskGroup taskGroup = (TaskGroup)session.get(
				TaskGroupImpl.class, primaryKey);
			...
			if (taskGroup == null) {
				...
				throw new NoSuchTaskGroupException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(taskGroup);
		}
		catch (NoSuchTaskGroupException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	@Override
	protected TaskGroup removeImpl(TaskGroup taskGroup) {
		Session session = null;

		try {
			session = openSession();

			if (!session.contains(taskGroup)) {
				taskGroup = (TaskGroup)session.get(
					TaskGroupImpl.class, taskGroup.getPrimaryKeyObj());
			}
	...
	public TaskGroup updateImpl(TaskGroup taskGroup) {
		boolean isNew = taskGroup.isNew();

		if (!(taskGroup instanceof TaskGroupModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(taskGroup.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(taskGroup);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in taskGroup proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom TaskGroup implementation " +
					taskGroup.getClass());
		}

		TaskGroupModelImpl taskGroupModelImpl = (TaskGroupModelImpl)taskGroup;
		...
		if (isNew && (taskGroup.getCreateDate() == null)) {
			if (serviceContext == null) {
				taskGroup.setCreateDate(now);
			}
			else {
				taskGroup.setCreateDate(serviceContext.getCreateDate(now));
			}
		}

		if (!taskGroupModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				taskGroup.setModifiedDate(now);
			}
			else {
				taskGroup.setModifiedDate(serviceContext.getModifiedDate(now));
			}
		}
		...
		try {
			...
			if (taskGroup.isNew()) {
				...
				taskGroup = (TaskGroup)session.merge(taskGroup);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (!_columnBitmaskEnabled) {
			...
			Object[] args = new Object[] {taskGroupModelImpl.getCompanyId()};
			...
			args = new Object[] {
				taskGroupModelImpl.getCompanyId(), taskGroupModelImpl.isActive()
			};
			...
			args = new Object[] {taskGroupModelImpl.isActive()};
			...
			if ((taskGroupModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					taskGroupModelImpl.getOriginalCompanyId()
				};
				...
				args = new Object[] {taskGroupModelImpl.getCompanyId()};
			...
			if ((taskGroupModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					taskGroupModelImpl.getOriginalCompanyId(),
					taskGroupModelImpl.getOriginalActive()
				};
				...
				args = new Object[] {
					taskGroupModelImpl.getCompanyId(),
					taskGroupModelImpl.isActive()
				};
		...
		clearUniqueFindersCache(taskGroupModelImpl, false);
		cacheUniqueFindersCache(taskGroupModelImpl);
	...
	/**
	 * Returns the task group with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the task group
	 ...
	 */
	@Override
	public TaskGroup findByPrimaryKey(Serializable primaryKey)
		throws NoSuchTaskGroupException {

		TaskGroup taskGroup = fetchByPrimaryKey(primaryKey);
	...
	public TaskGroup findByPrimaryKey(long taskGroupId)
		...
		return findByPrimaryKey((Serializable)taskGroupId);
	}
	...
	public TaskGroup fetchByPrimaryKey(long taskGroupId) {
		return fetchByPrimaryKey((Serializable)taskGroupId);
	}
	 ...
	 */
	@Override
	public List<TaskGroup> findAll(int start, int end) {
	...
	public List<TaskGroup> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_TASKGROUP);
				...
				sql = _SQL_SELECT_TASKGROUP;

				if (pagination) {
					sql = sql.concat(TaskGroupModelImpl.ORDER_BY_JPQL);
				}
			}
	...
	public void removeAll() {
		for (TaskGroup taskGroup : findAll()) {
			remove(taskGroup);
		}
	}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_TASKGROUP);
	...
	/**
	 * Initializes the task group persistence.
	 */
	@Activate
	public void activate() {
		TaskGroupModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		TaskGroupModelImpl.setFinderCacheEnabled(finderCacheEnabled);

		_finderPathWithPaginationFindAll = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, TaskGroupImpl.class,
		...
		_finderPathWithoutPaginationFindByCompanyId = new FinderPath(
			...
			TaskGroupModelImpl.COMPANYID_COLUMN_BITMASK |
			TaskGroupModelImpl.PRIORITY_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByCompanyId_Active = new FinderPath(
			...
			TaskGroupModelImpl.COMPANYID_COLUMN_BITMASK |
			TaskGroupModelImpl.ACTIVE_COLUMN_BITMASK |
			TaskGroupModelImpl.PRIORITY_COLUMN_BITMASK);
		...
		_finderPathFetchByCode = new FinderPath(
			...
			TaskGroupModelImpl.CODE_COLUMN_BITMASK);
	...
	public void deactivate() {
		entityCache.removeCache(TaskGroupImpl.class.getName());
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.nss.taskcategory.model.TaskGroup"),
			true);
	}
	...
	private static final String _SQL_SELECT_TASKGROUP =
		"SELECT taskGroup FROM TaskGroup taskGroup";

	private static final String _SQL_SELECT_TASKGROUP_WHERE =
		"SELECT taskGroup FROM TaskGroup taskGroup WHERE ";

	private static final String _SQL_COUNT_TASKGROUP =
		"SELECT COUNT(taskGroup) FROM TaskGroup taskGroup";

	private static final String _SQL_COUNT_TASKGROUP_WHERE =
		"SELECT COUNT(taskGroup) FROM TaskGroup taskGroup WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "taskGroup.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No TaskGroup exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No TaskGroup exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		TaskGroupPersistenceImpl.class);
