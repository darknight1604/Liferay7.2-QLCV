 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nss.taskcategory.service.impl.CurrencyServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nss.taskcategory.service.impl.CurrencyServiceImpl
 * @generated
 */
public abstract class CurrencyServiceBaseImpl
	extends BaseServiceImpl
	implements CurrencyService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CurrencyService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nss.taskcategory.service.CurrencyServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CurrencyService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		currencyService = (CurrencyService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CurrencyService.class.getName();
	}
	...
	@Reference
	protected com.nss.taskcategory.service.CurrencyLocalService
