...
public class CurrencyServiceHttp {
	...
	public static com.nss.taskcategory.model.Currency addCurrency(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CurrencyServiceUtil.class, "addCurrency",
				_addCurrencyParameterTypes0);
			...
			return (com.nss.taskcategory.model.Currency)returnObj;
		}
	...
	public static com.nss.taskcategory.model.Currency updateCurrency(
			HttpPrincipal httpPrincipal, long currencyId, String name,
		...
		try {
			MethodKey methodKey = new MethodKey(
				CurrencyServiceUtil.class, "updateCurrency",
				_updateCurrencyParameterTypes1);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, currencyId, name, code, priority, active,
	...
	public static boolean hasAddPermission(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CurrencyServiceUtil.class, "hasAddPermission",
	...
	public static boolean hasUpdatePermission(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CurrencyServiceUtil.class, "hasUpdatePermission",
	...
	public static boolean hasViewPermission(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CurrencyServiceUtil.class, "hasViewPermission",
	...
	private static final Class<?>[] _updateCurrencyParameterTypes1 =
		new Class[] {
			long.class, String.class, String.class, int.class, boolean.class,
			String.class, com.liferay.portal.kernel.service.ServiceContext.class
		};
