 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nss.taskcategory.service.impl.CurrencyLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nss.taskcategory.service.impl.CurrencyLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class CurrencyLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements CurrencyLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CurrencyLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nss.taskcategory.service.CurrencyLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Currency.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return currencyPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return currencyPersistence.countWithDynamicQuery(
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CurrencyLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		currencyLocalService = (CurrencyLocalService)aopProxy;
	}
