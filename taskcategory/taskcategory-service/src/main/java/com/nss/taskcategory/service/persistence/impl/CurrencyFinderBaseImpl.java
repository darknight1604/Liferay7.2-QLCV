 ...
 * @generated
 */
public abstract class CurrencyFinderBaseImpl
	extends BasePersistenceImpl<Currency> {

	public CurrencyFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return currencyPersistence.getBadColumnNames();
	}
