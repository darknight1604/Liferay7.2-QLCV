...
public class CurrencyModelResourcePermissionRegistrar {

 @Activate
    public void activate(BundleContext bundleContext) {
        Dictionary<String, Object> properties = new HashMapDictionary<>();

        properties.put("model.class.name", Currency.class.getName());
        _serviceRegistration = bundleContext.registerService(
            ModelResourcePermission.class,
            ModelResourcePermissionFactory.create(
            		Currency.class, Currency::getCurrencyId,
            		_currencyLocalService::getCurrency, _portletResourcePermission,
                (modelResourcePermission, consumer) -> {
                    ...
                    consumer.accept(
                        new WorkflowedModelPermissionLogic<>(
                                ...
                                _groupLocalService, Currency::getCurrencyId));
                }),
            properties);
    }
