 ...
 * @generated
 */
public abstract class TaskGroupFinderBaseImpl
	extends BasePersistenceImpl<TaskGroup> {

	public TaskGroupFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return taskGroupPersistence.getBadColumnNames();
	}
