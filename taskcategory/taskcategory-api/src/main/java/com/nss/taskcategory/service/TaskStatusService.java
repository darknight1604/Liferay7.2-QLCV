...
public interface TaskStatusService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TaskStatusServiceUtil} to access the task status remote service. Add custom service methods to <code>com.nss.taskcategory.service.impl.TaskStatusServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
