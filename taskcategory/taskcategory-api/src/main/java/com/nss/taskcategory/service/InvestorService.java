...
/**
 * Provides the remote service interface for Investor. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see InvestorServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface InvestorService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InvestorServiceUtil} to access the investor remote service. Add custom service methods to <code>com.nss.taskcategory.service.impl.InvestorServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
